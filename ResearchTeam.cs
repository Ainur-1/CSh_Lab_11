...
namespace CSh_11
{
    class ResearchTeam : Team, INameAndCopy, IComparer<ResearchTeam>
    {
        ...
        public string Name
        {
            ...
            {
                this.theme = value;
                PropertyChanged(this, new ResearchTeamsChangedEventArgs("None", Revision.Property, "Name", this.RegistrationNumber));
            }
        }
        ...
        public TimeFrame DurationOfResearch
        {
            get
            {
                return durationOfResearch;
            }
            set
            {
                durationOfResearch = value;
                PropertyChanged(this, new ResearchTeamsChangedEventArgs("None", Revision.Property, "DurationOfResearch", this.RegistrationNumber));
            }
        }
        ...
        //Делегаты и События
        public delegate void ResearchTeamListHandler(object source, ResearchTeamsChangedEventArgs args);
        public event ResearchTeamListHandler PropertyChanged;
    }
}
